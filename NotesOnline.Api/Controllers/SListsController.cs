...
namespace NotesOnline.Api.Controllers
{
    /// <summary>
    ...
    public class SListsController : ControllerBase
    {
        ...
        {
            int userId = int.Parse(User.Claims.FirstOrDefault(c => c.Type == IdType)?.Value!);
        ...
        public async Task<ActionResult<SListReadDto>> CreateList(SListCreateDto sListCreateDto)
        {
            ...
            return CreatedAtRoute(nameof(GetListById), new { sListReadDto.Id }, sListReadDto);
        }
